		...
		<a-col :xs="24" :sm="24" :md="7" :lg="7" :xl="7" class="mb-3">
			<a-card :bordered="false">
				...
				<div class="account-center-team">
					<div class="mb-2 sys-wd" v-if="userInfo.signature">
						<a-image :src="userInfo.signature" width="100%" class="sys-bdr236 sys-ht120"/>
					</div>
					<a-button @click="sysSignNameRef.show()">打开签名板</a-button>
					<SysSignName ref="sysSignNameRef" :image="userInfo.signature" @successful="signSuccess"/>
				</div>
			</a-card>
		</a-col>

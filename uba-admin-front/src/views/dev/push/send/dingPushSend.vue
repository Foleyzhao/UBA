<template>
	<a-form ref="formRef" :model="formData" :rules="formRules" layout="vertical">
		<a-form-item label="推送方式：" name="pushType">
			<a-radio-group v-model:value="formData.pushType" button-style="solid"
						   @change="pushTypeChange(formData.pushType)">
...
import {SysMdEditor} from '@/components/SysMdEditor/mdEditor'

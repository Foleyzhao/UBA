		...
		<a-card title="CPU监控" :bordered="false" class="mb-2">
			<a-descriptions size="middle" :column="2" bordered>
				...
				<a-descriptions-item label="CPU物理核心数">{{
						devMonitorCpuInfo.cpuPhysicalCoreNum
					}}
				</a-descriptions-item>
				<a-descriptions-item label="CPU逻辑核心数">{{
						devMonitorCpuInfo.cpuLogicalCoreNum
					}}
				</a-descriptions-item>
			</a-descriptions>
		</a-card>
				...
				<a-card title="JVM信息" :bordered="false">
					<a-descriptions size="middle" :column="2" bordered>
						...
						<a-descriptions-item label="JVM启动时间">{{
								devMonitorJvmInfo.jvmStartTime
							}}
						</a-descriptions-item>
						<a-descriptions-item label="JVM运行时长">{{
								devMonitorJvmInfo.jvmRunTime
							}}
						</a-descriptions-item>
		...
		<a-card title="服务器信息" :bordered="false" class="mb-2">
			<a-descriptions size="middle" :column="2" bordered>
				...
				<a-descriptions-item label="服务器架构">{{
						devMonitorServerInfo.serverArchitecture
					}}
				</a-descriptions-item>
			</a-descriptions>
		</a-card>

			...
			<a-row :gutter="16">
				...
				<a-col :span="12" v-if="formData.menuType !== 'CATALOG'">
					<a-form-item name="path">
						<template #label>
							<a-tooltip>
								<template #title>
									类型为内外链时，输入https开头的链接即可（例：https://www.huanniankj.com）
								</template>
				...
				<a-col :span="12">
					<a-form-item label="是否正规则：" name="regType">
						<a-radio-group v-model:value="formData.regType" placeholder="请选择正规则"
									   :options="regTypeOptions"/>
					</a-form-item>
				</a-col>
				<a-col :span="12">
					<a-form-item label="可用状态：" name="status">
						<a-radio-group v-model:value="formData.status" placeholder="请选择可用状态"
									   :options="statusOptions"/>
					</a-form-item>
				</a-col>
				<a-col :span="12">
					<a-form-item label="排序码：" name="sortCode">
						<a-input-number class="sys-wd" v-model:value="formData.sortCode" placeholder="请输入排序码"
										:max="1000"/>
					</a-form-item>
				</a-col>
			</a-row>

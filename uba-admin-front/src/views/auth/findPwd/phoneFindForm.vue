	...
	<a-form ref="phoneLoginFormRef" :model="phoneFormData" :rules="formRules">
		<a-form-item name="phone">
			<a-input v-model:value="phoneFormData.phone" :placeholder="$t('login.phonePlaceholder')" size="large">
				<template #prefix>
					<mobile-outlined class="sys-color-00025"/>
				</template>
			</a-input>
		</a-form-item>
		<a-form-item name="phoneValidCode">
			<a-row :gutter="8">
				<a-col :span="17">
					...
					>
						<template #prefix>
							<mail-outlined class="sys-color-00025"/>
						</template>
					</a-input>
				</a-col>
				<a-col :span="7">
					<a-button size="large" class="sys-wd" @click="getPhoneValidCode" :disabled="state.smsSendBtn">{{
		...
		<a-form-item name="newPassword">
			...
			>
				<template #prefix>
					<LockOutlined class="sys-color-00025"/>
				</template>
			</a-input-password>
		</a-form-item>
		...
		<a-form-item>
			<a-row :gutter="8">
				<a-col :span="7">
					<a-button class="sys-wd" round size="large" href="/login">{{ $t('login.backLogin') }}</a-button>
				</a-col>
				<a-col :span="17">
					<a-button type="primary" class="sys-wd" :loading="islogin" round size="large" @click="submitReset">{{
		...
		<a-form ref="phoneLoginFormModalRef" :model="phoneFormModalData" :rules="formModalRules">
			<a-form-item name="validCode">
				<a-row :gutter="8">
					...
					<a-col :span="7">
						<img :src="validCodeBase64" class="sys-findform-line" @click="getPhonePicCaptcha"/>
					</a-col>
				</a-row>
			</a-form-item>
		</a-form>

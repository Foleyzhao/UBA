				...
				<a-card>
					...
					>
						...
						<a-form-item name="newPassword">
							<a-input-password v-model:value="registerFormData.newPassword" placeholder="请再次输入密码"
											  size="large">
								<template #prefix>
									<lock-outlined class="login-icon-gray"/>
								</template>
						...
						<div style="display: flex; justify-content: flex-end">
							<a href="/front/client/login" class="sys-color-0d84ff">已有账号？前往登录</a>
						</div>
					</a-form>
				</a-card>
			</div>

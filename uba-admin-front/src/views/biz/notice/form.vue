			...
			<a-row :gutter="16">
				...
				<a-col :span="5">
					<a-form-item label="封面图：" name="image">
						<sys-upload v-model:value="formData.image" uploadMode="image"/>
					</a-form-item>
				</a-col>
				<a-col :span="24">
					<a-form-item label="内容：" name="content">
						<sys-editor v-model:value="formData.content" placeholder="请输入内容"/>
					</a-form-item>
				</a-col>
				<a-col :span="24">
				...
				<a-col :span="18">
					<a-form-item label="发布位置：" name="place">
						<a-checkbox-group v-model:value="formData.place" placeholder="请选择发布位置"

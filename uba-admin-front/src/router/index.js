...
// 设置标题
// document.title = sysBaseConfig.SYSTEM_SYS_NAME
...
router.beforeEach(async (to, from, next) => {
	...
	const sysBaseConfig = tool.data.get('SYSTEM_SYS_BASE_CONFIG') || store.sysBaseConfig
	// 动态标题
	document.title = to.meta.title
		? `${to.meta.title} - ${sysBaseConfig.SYSTEM_SYS_NAME}`
		: `${sysBaseConfig.SYSTEM_SYS_NAME}`

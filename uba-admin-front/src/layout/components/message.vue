<template>
	<div class="msg panel-item" @click="showMsg">
		...
		<sys-form-container title="详情" :width="700" :open="visible" :destroy-on-close="true" @close="onClose">
					...
					>
						<template #bodyCell="{ column, record }">
							<template v-if="column.dataIndex === 'read'">
								<span v-if="record.read" class="sys-color-d9d9d9">已读</span>
								<span v-else class="sys-color-ff4d4f">未读</span>
							</template>
						</template>
					</s-table>
				</a-form-item>

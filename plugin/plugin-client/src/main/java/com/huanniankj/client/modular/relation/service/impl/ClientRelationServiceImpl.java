package com.huanniankj.client.modular.relation.service.impl;
...
import com.huanniankj.client.modular.relation.entity.ClientRelation;
import com.huanniankj.client.modular.relation.mapper.ClientRelationMapper;
import com.huanniankj.client.modular.relation.service.ClientRelationService;
 ...
 */
@Service
public class ClientRelationServiceImpl extends ServiceImpl<ClientRelationMapper, ClientRelation>
    ...
    @Transactional(rollbackFor = Exception.class)
    public void saveRelationBatch(String objectId, List<String> targetIdList, String category,
                                  List<String> extJsonList, boolean clear) {
        // 是否需要先删除关系
        if(clear) {
            this.remove(new LambdaQueryWrapper<ClientRelation>().eq(ClientRelation::getObjectId, objectId)
                    .eq(ClientRelation::getCategory, category));

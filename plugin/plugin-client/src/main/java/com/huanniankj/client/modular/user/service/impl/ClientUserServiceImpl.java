...
import com.huanniankj.client.core.util.ClientEmailFormatUtl;
import com.huanniankj.client.core.util.ClientPasswordUtl;
...
import com.huanniankj.client.modular.user.enums.ClientUpdatePasswordValidTypeEnum;
...
import com.huanniankj.client.modular.user.mapper.ClientUserMapper;
...
public class ClientUserServiceImpl extends ServiceImpl<ClientUserMapper, ClientUser> implements ClientUserService {
     ...
     * C端重置密码验证码短信消息模板
     */
    private static final String SYSTEM_SMS_TEMPLATE_VALID_CODE_RESET_PASSWORD_FOR_C_KEY =
            "SYSTEM_SMS_TEMPLATE_VALID_CODE_RESET_PASSWORD_FOR_C";

    /**
     * C端重置密码验证码邮件消息模板
     */
    private static final String SYSTEM_EMAIL_TEMPLATE_VALID_CODE_RESET_PASSWORD_FOR_C_KEY =
            "SYSTEM_EMAIL_TEMPLATE_VALID_CODE_RESET_PASSWORD_FOR_C";

    /**
     * C端修改密码验证码短信消息模板
     */
    private static final String SYSTEM_SMS_TEMPLATE_VALID_CODE_UPDATE_PASSWORD_FOR_C_KEY =
            "SYSTEM_SMS_TEMPLATE_VALID_CODE_UPDATE_PASSWORD_FOR_C";

    /**
     * C端修改密码验证码邮件消息模板
     */
    private static final String SYSTEM_EMAIL_TEMPLATE_VALID_CODE_UPDATE_PASSWORD_FOR_C_KEY =
            "SYSTEM_EMAIL_TEMPLATE_VALID_CODE_UPDATE_PASSWORD_FOR_C";

    /**
     * C端重置密码成功短信消息模板
     */
    private static final String SYSTEM_SMS_TEMPLATE_NOTICE_PASSWORD_RESET_SUCCESS_FOR_C_KEY =
            "SYSTEM_SMS_TEMPLATE_NOTICE_PASSWORD_RESET_SUCCESS_FOR_C";

    /**
     * C端重置密码成功邮件消息模板
     */
    private static final String SYSTEM_EMAIL_TEMPLATE_NOTICE_PASSWORD_RESET_SUCCESS_FOR_C_KEY =
            "SYSTEM_EMAIL_TEMPLATE_NOTICE_PASSWORD_RESET_SUCCESS_FOR_C";

    /**
     * C端密码即将到期短信消息模板
     */
    private static final String SYSTEM_SMS_TEMPLATE_NOTICE_PASSWORD_EXPIRED_FOR_C_KEY =
            "SYSTEM_SMS_TEMPLATE_NOTICE_PASSWORD_EXPIRED_FOR_C";

    /**
     * C端密码即将到期邮件消息模板
     */
    private static final String SYSTEM_EMAIL_TEMPLATE_NOTICE_PASSWORD_EXPIRED_FOR_C_KEY =
            "SYSTEM_EMAIL_TEMPLATE_NOTICE_PASSWORD_EXPIRED_FOR_C";

    /**
     * C端绑定手机验证码短信消息模板
     */
    private static final String SYSTEM_SMS_TEMPLATE_VALID_CODE_BINDING_PHONE_FOR_C_KEY =
            "SYSTEM_SMS_TEMPLATE_VALID_CODE_BINDING_PHONE_FOR_C";

    /**
     * C端绑定邮箱验证码邮件消息模板
     */
    private static final String SYSTEM_EMAIL_TEMPLATE_VALID_CODE_BINDING_EMAIL_FOR_C_KEY =
            "SYSTEM_EMAIL_TEMPLATE_VALID_CODE_BINDING_EMAIL_FOR_C";

    /**
     * C端修改绑定手机验证码短信消息模板
     */
    private static final String SYSTEM_SMS_TEMPLATE_VALID_CODE_UPDATE_BINDING_PHONE_FOR_C_KEY =
            "SYSTEM_SMS_TEMPLATE_VALID_CODE_UPDATE_BINDING_PHONE_FOR_C";

    /**
     * C端修改绑定邮箱验证码邮件消息模板
     */
    private static final String SYSTEM_EMAIL_TEMPLATE_VALID_CODE_UPDATE_BINDING_EMAIL_FOR_C_KEY =
            "SYSTEM_EMAIL_TEMPLATE_VALID_CODE_UPDATE_BINDING_EMAIL_FOR_C";

    /**
     * C端注册账号成功短信消息模板
     */
    private static final String SYSTEM_SMS_TEMPLATE_NOTICE_REGISTER_SUCCESS_FOR_C_KEY =
            "SYSTEM_SMS_TEMPLATE_NOTICE_REGISTER_SUCCESS_FOR_C";

    /**
     * C端注册账号成功邮件消息模板
     */
    private static final String SYSTEM_EMAIL_TEMPLATE_NOTICE_REGISTER_SUCCESS_FOR_C_KEY =
            "SYSTEM_EMAIL_TEMPLATE_NOTICE_REGISTER_SUCCESS_FOR_C";

    /**
     * C端注册后是否需要绑定手机号
     */
    private static final String SYSTEM_SYS_DEFAULT_REGISTER_NEED_BIND_PHONE_FOR_C_KEY =
            "SYSTEM_SYS_DEFAULT_REGISTER_NEED_BIND_PHONE_FOR_C";

    /**
     * C端注册后是否需要绑定邮箱
     */
    private static final String SYSTEM_SYS_DEFAULT_REGISTER_NEED_BIND_EMAIL_FOR_C_KEY =
            "SYSTEM_SYS_DEFAULT_REGISTER_NEED_BIND_EMAIL_FOR_C";
    ...
    public ClientLoginUser getUserByPhone(String phone) {
        ClientUser clientUser = this.getOne(new LambdaQueryWrapper<ClientUser>().eq(ClientUser::getPhone,
    ...
    public Page<ClientUser> page(ClientUserPageParam clientUserPageParam) {
        ...
        if (ObjectUtil.isNotEmpty(clientUserPageParam.getSearchKey())) {
            queryWrapper.lambda().and(q -> q.like(ClientUser::getName,
                            clientUserPageParam.getSearchKey())
        ...
        if (ObjectUtil.isAllNotEmpty(clientUserPageParam.getSortField(), clientUserPageParam.getSortOrder())) {
            ...
            queryWrapper.orderBy(true, clientUserPageParam.getSortOrder()
    ...
    private void checkParam(ClientUserAddParam clientUserAddParam) {
        ...
        if (ObjectUtil.isNotEmpty(clientUserAddParam.getPhone())) {
            ...
            if (this.count(new LambdaQueryWrapper<ClientUser>()
                    .eq(ClientUser::getPhone,
                            CommonCryptogramUtil.doSm4CbcEncrypt(clientUserAddParam.getPhone()))) > 0) {
    ...
    public void updateUserInfo(ClientUserUpdateInfoParam clientUserUpdateInfoParam) {
        ...
        LambdaUpdateWrapper<ClientUser> lambdaUpdateWrapper = new LambdaUpdateWrapper<ClientUser>()
    ...
    private void validValidCode(String phoneOrEmail, String validCode, String validCodeReqNo) {
        ...
        if (ObjectUtil.isEmpty(phoneOrEmail)) {
            ...
            existValidCode = commonCacheOperator.get(USER_VALID_CODE_CACHE_KEY + phoneOrEmail
        ...
        if (ObjectUtil.isEmpty(phoneOrEmail)) {
            ...
            commonCacheOperator.remove(USER_VALID_CODE_CACHE_KEY + phoneOrEmail
                    + StrUtil.UNDERLINE + validCodeReqNo);
        }
        // 不一致则直接验证码错误
    ...
    public String findPasswordGetPhoneValidCode(ClientUserGetPhoneValidCodeParam clientUserGetPhoneValidCodeParam) {
        return this.getPhoneValidCode(clientUserGetPhoneValidCodeParam, "重置密码验证码短信消息模板编码",
                SYSTEM_SMS_TEMPLATE_VALID_CODE_RESET_PASSWORD_FOR_C_KEY);
    }

    /**
     * 获取手机验证码
     */
    private String getPhoneValidCode(ClientUserGetPhoneValidCodeParam clientUserGetPhoneValidCodeParam,
        ...
        // 执行校验验证码
        validValidCode(null, clientUserGetPhoneValidCodeParam.getValidCode(),
                clientUserGetPhoneValidCodeParam.getValidCodeReqNo());
    ...
    public String findPasswordGetEmailValidCode(ClientUserGetEmailValidCodeParam clientUserGetEmailValidCodeParam) {
        return this.getEmailValidCode(clientUserGetEmailValidCodeParam, "重置密码验证码邮件消息模板内容",
                SYSTEM_EMAIL_TEMPLATE_VALID_CODE_RESET_PASSWORD_FOR_C_KEY);
    }

    /**
     * 获取邮箱验证码
     */
    private String getEmailValidCode(ClientUserGetEmailValidCodeParam clientUserGetEmailValidCodeParam,
        ...
        // 执行校验验证码
        validValidCode(null, clientUserGetEmailValidCodeParam.getValidCode(),
                clientUserGetEmailValidCodeParam.getValidCodeReqNo());
        // 根据邮箱获取用户信息，判断用户是否存在
    ...
    public void findPasswordByPhone(ClientUserFindPwdByPhoneParam clientUserFindPwdByPhoneParam) {
        ...
        // 执行校验验证码
        validValidCode(phone, clientUserFindPwdByPhoneParam.getValidCode(),
                clientUserFindPwdByPhoneParam.getValidCodeReqNo());
        // 获取新密码
        ...
        // 重置密码成功短信消息模板编码
        String smsTemplateCode = devConfigApi.getValueByKey(SYSTEM_SMS_TEMPLATE_NOTICE_PASSWORD_RESET_SUCCESS_FOR_C_KEY);
        // 不为空才发送
    ...
    public void findPasswordByEmail(ClientUserFindPwdByEmailParam clientUserFindPwdByEmailParam) {
        ...
        // 执行校验验证码
        validValidCode(email, clientUserFindPwdByEmailParam.getValidCode(),
                clientUserFindPwdByEmailParam.getValidCodeReqNo());
        // 获取新密码
        ...
        String emailTemplateContent =
                devConfigApi.getValueByKey(SYSTEM_EMAIL_TEMPLATE_NOTICE_PASSWORD_RESET_SUCCESS_FOR_C_KEY);
        // 不为空才发送
        if (ObjectUtil.isNotEmpty(emailTemplateContent)) {
            // 模板内容转为JSONObject
            JSONObject contentJSONObject = JSONUtil.parseObj(emailTemplateContent);
            // 定义变量参数
            JSONObject paramMap = JSONUtil.createObj().set("userEmail", clientUserFindPwdByEmailParam.getEmail())

                    .set("userNewPassword", newPassword);
            // 获取格式化后的主题
            String subject = ClientEmailFormatUtl.format(contentJSONObject.getStr("subject"), paramMap);
            ;
            // 获取格式化后的内容
    ...
    public String updatePasswordGetPhoneValidCode(ClientUserGetPhoneValidCodeParam clientUserGetPhoneValidCodeParam) {
        ...
        return this.getPhoneValidCode(clientUserGetPhoneValidCodeParam, "修改密码验证码短信消息模板编码",
                SYSTEM_SMS_TEMPLATE_VALID_CODE_UPDATE_PASSWORD_FOR_C_KEY);
    }
    ...
    public String updatePasswordGetEmailValidCode(ClientUserGetEmailValidCodeParam clientUserGetEmailValidCodeParam) {
        ...
        return this.getEmailValidCode(clientUserGetEmailValidCodeParam, "修改密码验证码邮件消息模板内容",
                SYSTEM_EMAIL_TEMPLATE_VALID_CODE_UPDATE_PASSWORD_FOR_C_KEY);
    }
    ...
    public void updatePasswordByOld(ClientUserUpdatePwdByOldParam clientUserUpdatePwdByOldParam) {
        ...
        if (ObjectUtil.isNotEmpty(phone)) {
            ...
            String smsTemplateCode =
                    devConfigApi.getValueByKey(SYSTEM_SMS_TEMPLATE_NOTICE_PASSWORD_RESET_SUCCESS_FOR_C_KEY);
            // 不为空才发送
            if (ObjectUtil.isNotEmpty(smsTemplateCode)) {
                // 模板内容转为JSONObject
                JSONObject contentJSONObject = JSONUtil.parseObj(smsTemplateCode);
    ...
    public String bindPhoneGetPhoneValidCode(ClientUserGetPhoneValidCodeParam clientUserGetPhoneValidCodeParam) {
        ...
        String phoneValidCodeReqNo = IdWorker.getIdStr();
        // 绑定手机验证码短信消息模板编码
        String smsTemplateCode = devConfigApi.getValueByKey(SYSTEM_SMS_TEMPLATE_VALID_CODE_BINDING_PHONE_FOR_C_KEY);
        if (ObjectUtil.isEmpty(smsTemplateCode)) {
    ...
    public String updateBindPhoneGetPhoneValidCode(ClientUserGetPhoneValidCodeParam clientUserGetPhoneValidCodeParam) {
        ...
        // 修改绑定手机验证码短信消息模板编码
        String smsTemplateCode =
                devConfigApi.getValueByKey(SYSTEM_SMS_TEMPLATE_VALID_CODE_UPDATE_BINDING_PHONE_FOR_C_KEY);
        if (ObjectUtil.isEmpty(smsTemplateCode)) {
    ...
    public String bindEmailGetEmailValidCode(ClientUserGetEmailValidCodeParam clientUserGetEmailValidCodeParam) {
        ...
        // 绑定邮箱验证码邮件消息模板内容
        String emailTemplateContent =
                devConfigApi.getValueByKey(SYSTEM_EMAIL_TEMPLATE_VALID_CODE_BINDING_EMAIL_FOR_C_KEY);
        if (ObjectUtil.isEmpty(emailTemplateContent)) {
    ...
    public String updateBindEmailGetEmailValidCode(ClientUserGetEmailValidCodeParam clientUserGetEmailValidCodeParam) {
        ...
        // 修改绑定邮箱验证码邮件消息模板内容
        String emailTemplateContent =
                devConfigApi.getValueByKey(SYSTEM_EMAIL_TEMPLATE_VALID_CODE_UPDATE_BINDING_EMAIL_FOR_C_KEY);
        if (ObjectUtil.isEmpty(emailTemplateContent)) {
        ...
        devEmailApi.sendDynamicHtmlEmail(email, subject, content);
        // 将请求号作为key，验证码的值作为value放到redis，用于校验
        commonCacheOperator.put(USER_VALID_CODE_CACHE_KEY + email + StrUtil.UNDERLINE +
    ...
    public ClientUser createUserWithPhone(String phone) {
        ...
        ClientUser clientUser = this.getOne(new LambdaQueryWrapper<ClientUser>().eq(ClientUser::getPhone,
                CommonCryptogramUtil.doSm4CbcEncrypt(phone)));
        // 发送注册成功短信
        String smsTemplateCode = devConfigApi.getValueByKey(SYSTEM_SMS_TEMPLATE_NOTICE_REGISTER_SUCCESS_FOR_C_KEY);
        // 不为空才发送
        if (ObjectUtil.isNotEmpty(smsTemplateCode)) {
            // 模板内容转为JSONObject
            JSONObject contentJSONObject = JSONUtil.parseObj(smsTemplateCode);
    ...
    public ClientUser createUserWithEmail(String email) {
        ...
        // 发送注册成功邮件
        String emailTemplateContent =
                devConfigApi.getValueByKey(SYSTEM_EMAIL_TEMPLATE_NOTICE_REGISTER_SUCCESS_FOR_C_KEY);
        // 不为空才发送
        if (ObjectUtil.isNotEmpty(emailTemplateContent)) {
            // 模板内容转为JSONObject
            JSONObject contentJSONObject = JSONUtil.parseObj(emailTemplateContent);
    ...
    public Boolean isUserNeedBindPhone() {
        ...
        ClientUserExt clientUserExt = clientUserExtService.getOne(new LambdaQueryWrapper<ClientUserExt>()
                .eq(ClientUserExt::getUserId, StpClientUtil.getLoginIdAsString())
        ...
        if (ObjectUtil.isNotEmpty(clientUserExt)) {
            ...
            if (ObjectUtil.isEmpty(clientUser.getPhone())) {
                String registerNeedBindPhone =
                        devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_REGISTER_NEED_BIND_PHONE_FOR_C_KEY);
        ...
        if (ObjectUtil.isNotEmpty(clientUserExt)) {
            ...
            if (ObjectUtil.isEmpty(clientUser.getEmail())) {
                String registerNeedBindEmail =
                        devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_REGISTER_NEED_BIND_EMAIL_FOR_C_KEY);
    ...
    public void noticeUserPasswordAboutToExpired() {
        // 密码即将到期短信消息模板
        String smsTemplateCode = devConfigApi.getValueByKey(SYSTEM_SMS_TEMPLATE_NOTICE_PASSWORD_EXPIRED_FOR_C_KEY);
        // 密码即将到期邮件消息模板
        String emailTemplateContent = devConfigApi.getValueByKey(SYSTEM_EMAIL_TEMPLATE_NOTICE_PASSWORD_EXPIRED_FOR_C_KEY);
        // 获取今日需要提醒密码到期的用户集合

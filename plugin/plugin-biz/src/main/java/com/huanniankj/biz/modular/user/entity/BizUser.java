package com.huanniankj.biz.modular.user.entity;
...
import com.huanniankj.common.handler.CommonSm4CbcTypeHandler;
...
public class BizUser extends CommonEntity {
    ...
    @TableField(insertStrategy = FieldStrategy.ALWAYS, updateStrategy = FieldStrategy.ALWAYS,
            typeHandler = CommonSm4CbcTypeHandler.class)
    ...
    @Trans(type = TransType.SIMPLE, target = BizPosition.class, fields = "name", alias = "position",
            ref = "positionName")

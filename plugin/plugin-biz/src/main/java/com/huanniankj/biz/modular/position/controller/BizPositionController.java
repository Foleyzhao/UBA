package com.huanniankj.biz.modular.position.controller;
...
public class BizPositionController {
    ...
    public CommonResult<Page<BizPosition>> positionSelector(
            BizPositionSelectorPositionParam bizPositionSelectorPositionParam) {

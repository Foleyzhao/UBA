package com.huanniankj.dev.modular.monitor.service.impl;
...
import com.huanniankj.common.util.CommonNetWorkInfoUtil;
...
public class DevMonitorServiceImpl implements DevMonitorService {
    ...
    public DevMonitorServerResult serverInfo() {
        ...
        devMonitorCpuInfo.setCpuTotalUseRate(NumberUtil.div(NumberUtil.mul(NumberUtil.add(sys, user), 100), totalCpu,
                2));
        ...
        DevMonitorServerResult.DevMonitorMemoryInfo devMonitorMemoryInfo =
                new DevMonitorServerResult.DevMonitorMemoryInfo();
        ...
        // 存储信息
        DevMonitorServerResult.DevMonitorStorageInfo devMonitorStorageInfo =
                new DevMonitorServerResult.DevMonitorStorageInfo();
        ...
        devMonitorStorageInfo.setStorageUseRate(NumberUtil.mul(NumberUtil.div(storageUsed.doubleValue(),
                storageTotal.doubleValue(), 4), 100));
        devMonitorServerResult.setDevMonitorStorageInfo(devMonitorStorageInfo);

        // 服务器信息
        OsInfo osInfo = SystemUtil.getOsInfo();
        DevMonitorServerResult.DevMonitorServerInfo devMonitorServerInfo =
                new DevMonitorServerResult.DevMonitorServerInfo();
    ...
    public DevMonitorServerResult networkInfo(){
        DevMonitorServerResult devMonitorServerResult = new DevMonitorServerResult();
        // 网络信息
        DevMonitorServerResult.DevMonitorNetworkInfo devMonitorNetworkInfo =
                new DevMonitorServerResult.DevMonitorNetworkInfo();

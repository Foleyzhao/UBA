package com.huanniankj.sys.modular.role.service.impl;
...
import com.huanniankj.sys.modular.role.enums.SysRoleCategoryEnum;
import com.huanniankj.sys.modular.role.mapper.SysRoleMapper;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements SysRoleService {
    ...
    public Page<SysRole> page(SysRolePageParam sysRolePageParam) {
        ...
        if (ObjectUtil.isAllNotEmpty(sysRolePageParam.getSortField(), sysRolePageParam.getSortOrder())) {
            ...
            queryWrapper.orderBy(true, sysRolePageParam.getSortOrder()
    ...
    public void add(SysRoleAddParam sysRoleAddParam) {
        ...
        // 发布增加事件
        CommonDataChangeEventCenter.doAddWithData(SysDataTypeEnum.ROLE.getValue(),
                JSONUtil.createArray().put(sysRole));
    }
    ...
    private void checkParam(SysRoleAddParam sysRoleAddParam) {
        ...
        boolean repeatName = this.count(new LambdaQueryWrapper<SysRole>()
                .eq(SysRole::getOrgId, sysRoleAddParam.getOrgId())
        ...
        boolean repeatCode = this.count(new LambdaQueryWrapper<SysRole>()
                .eq(SysRole::getOrgId, sysRoleAddParam.getOrgId())
    ...
    public void edit(SysRoleEditParam sysRoleEditParam) {
        ...
        // 发布更新事件
        CommonDataChangeEventCenter.doUpdateWithData(SysDataTypeEnum.ROLE.getValue(),
                JSONUtil.createArray().put(sysRole));
    }
    ...
    private void checkParam(SysRoleEditParam sysRoleEditParam) {
        ...
        boolean repeatName = this.count(new LambdaQueryWrapper<SysRole>()
                .eq(SysRole::getOrgId, sysRoleEditParam.getOrgId())
    ...
    public SysRoleOwnResourceResult ownResource(SysRoleIdParam sysRoleIdParam) {
        ...
        sysRoleOwnResourceResult.setGrantInfoList(
                sysRelationService.getRelationListByObjectIdAndCategory(sysRoleIdParam.getId(),
                                SysRelationCategoryEnum.SYS_ROLE_HAS_RESOURCE.getValue()).stream()
                        .map(sysRelation -> JSONUtil.toBean(sysRelation.getExtJson(),
                                SysRoleOwnResourceResult.SysRoleOwnResource.class))
    ...
    public void grantResource(SysRoleGrantResourceParam sysRoleGrantResourceParam) {
        ...
        if (!SysBuildInEnum.BUILD_IN_ROLE_CODE.getValue().equals(sysRole.getCode())) {
            if (ObjectUtil.isNotEmpty(menuIdList)) {
                Set<String> sysModuleIdList = sysMenuService.listByIds(menuIdList).stream().map(SysMenu::getModule)
                        .collect(Collectors.toSet());
                boolean containsSystemModule = sysModuleService.listByIds(sysModuleIdList).stream()
                        .map(SysModule::getCode)
        ...
        sysRelationService.saveRelationBatchWithClear(id, menuIdList,
    ...
    public SysRoleOwnMobileMenuResult ownMobileMenu(SysRoleIdParam sysRoleIdParam) {
        ...
        sysRoleOwnMobileMenuResult.setGrantInfoList(
                sysRelationService.getRelationListByObjectIdAndCategory(sysRoleIdParam.getId(),
                                SysRelationCategoryEnum.SYS_ROLE_HAS_MOBILE_MENU.getValue()).stream()
                        .map(sysRelation -> JSONUtil.toBean(sysRelation.getExtJson(),
                                SysRoleOwnMobileMenuResult.SysRoleOwnMobileMenu.class))
                        .collect(Collectors.toList()));
    ...
    public void grantMobileMenu(SysRoleGrantMobileMenuParam sysRoleGrantMobileMenuParam) {
        ...
        List<String> extJsonList = sysRoleGrantMobileMenuParam.getGrantInfoList().stream()
                .map(JSONUtil::toJsonStr).collect(Collectors.toList());
        sysRelationService.saveRelationBatchWithClear(id, menuIdList,
                SysRelationCategoryEnum.SYS_ROLE_HAS_MOBILE_MENU.getValue(), extJsonList);
    }
    ...
    public SysRoleOwnPermissionResult ownPermission(SysRoleIdParam sysRoleIdParam) {
        ...
        sysRoleOwnPermissionResult.setGrantInfoList(
                sysRelationService.getRelationListByObjectIdAndCategory(sysRoleIdParam.getId(),
                                SysRelationCategoryEnum.SYS_ROLE_HAS_PERMISSION.getValue()).stream()
                        .map(sysRelation -> JSONUtil.toBean(sysRelation.getExtJson(),
                                SysRoleOwnPermissionResult.SysRoleOwnPermission.class))
                        .collect(Collectors.toList()));
    ...
    public void grantPermission(SysRoleGrantPermissionParam sysRoleGrantPermissionParam) {
        ...
        sysRelationService.saveRelationBatchWithClear(id, apiUrlList,
                SysRelationCategoryEnum.SYS_ROLE_HAS_PERMISSION.getValue(), extJsonList);
    }
    ...
    public List<SysRoleGrantResourceTreeResult> resourceTreeSelector(boolean containsTen) {
        ...
        lambdaQueryWrapper.in(SysMenu::getCategory, SysResourceCategoryEnum.MODULE.getValue(),
    ...
    public List<SysRoleGrantResourceTreeResult> resourceTreeSelector(List<SysMenu> originDataList) {
        ...
        List<SysRoleGrantResourceTreeResult.SysRoleGrantResourceMenuResult> leafMenuList =
        ...
        sysMenuList.forEach(sysMenu -> {
            ...
            if (isLeafMenu) {
                ...
                List<String> parentIdSplitList =
                        StrUtil.split(parentJsonObject.getStr("parentId"), StrUtil.DASHED);
                List<String> parentNameSplitList =
                        StrUtil.split(parentJsonObject.getStr("parentName"), StrUtil.DASHED);
                ...
                sysRoleGrantResourceMenuResult.setButton(this.getChildListById(sysButtonList, sysMenu.getId(),
                                false)
        ...
        Map<String, List<SysRoleGrantResourceTreeResult.SysRoleGrantResourceMenuResult>> menuListGroup
                = leafMenuList.stream().collect(Collectors.groupingBy(
                        SysRoleGrantResourceTreeResult.SysRoleGrantResourceMenuResult::getModule));
    ...
    public List<SysRoleGrantMobileMenuTreeResult> mobileMenuTreeSelector(List<JSONObject> originDataList) {
        return BeanUtil.copyToList(mobileMenuApi.mobileMenuTreeSelector(originDataList),
                SysRoleGrantMobileMenuTreeResult.class);
    }
    ...
    public List<String> permissionTreeSelector() {
        ...
        SpringUtil.getApplicationContext().getBeansOfType(RequestMappingHandlerMapping.class).values()
                .forEach(requestMappingHandlerMapping ->
                        requestMappingHandlerMapping.getHandlerMethods()
                        .forEach((key, value) -> {
                            SaCheckPermission saCheckPermission = value.getMethod()
                            ...
                            if (ObjectUtil.isNotEmpty(saCheckPermission)) {
                                ...
                                if (pathPatternsCondition != null) {
                                    ...
                                    pathPatternsCondition.getPatterns().forEach(
                                            pt -> permissionResult.add(pt + nm));
                                }
                            }
                        }));

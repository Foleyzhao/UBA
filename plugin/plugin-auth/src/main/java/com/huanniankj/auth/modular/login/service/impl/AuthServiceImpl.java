package com.huanniankj.auth.modular.login.service.impl;
...
import com.huanniankj.auth.core.util.AuthEmailFormatUtil;
...
import com.huanniankj.auth.modular.login.enums.AuthDeviceTypeEnum;
import com.huanniankj.auth.modular.login.enums.AuthExceptionEnum;
import com.huanniankj.auth.modular.login.enums.AuthPhoneOrEmailTypeEnum;
import com.huanniankj.auth.modular.login.enums.AuthStrategyWhenNoUserWithPhoneOrEmailEnum;
...
import com.huanniankj.common.consts.CacheConstant;
...
import com.huanniankj.common.util.CommonTimeFormatUtil;
...
public class AuthServiceImpl implements AuthService {
     ...
     * B端验证码是否开启（适用图片验证码）
     */
    private static final String SYSTEM_SYS_DEFAULT_CAPTCHA_OPEN_FLAG_FOR_B_KEY =
            "SYSTEM_SYS_DEFAULT_CAPTCHA_OPEN_FLAG_FOR_B";

    /**
     * C端验证码是否开启（适用图片验证码）
     */
    private static final String SYSTEM_SYS_DEFAULT_CAPTCHA_OPEN_FLAG_FOR_C_KEY =
            "SYSTEM_SYS_DEFAULT_CAPTCHA_OPEN_FLAG_FOR_C";
     ...
     */
    private static final String SYSTEM_SYS_DEFAULT_CAPTCHA_EXPIRED_DURATION_FOR_C_KEY =
            "SYSTEM_SYS_DEFAULT_CAPTCHA_EXPIRED_DURATION_FOR_C";

    /**
     * B端登录验证码短信消息模板编码
     */
    private static final String SYSTEM_SMS_TEMPLATE_VALID_CODE_LOGIN_FOR_B_KEY =
            "SYSTEM_SMS_TEMPLATE_VALID_CODE_LOGIN_FOR_B";

    /**
     * C端登录验证码短信消息模板编码
     */
    private static final String SYSTEM_SMS_TEMPLATE_VALID_CODE_LOGIN_FOR_C_KEY =
            "SYSTEM_SMS_TEMPLATE_VALID_CODE_LOGIN_FOR_C";

    /**
     * B端登录验证码邮件消息模板内容
     */
    private static final String SYSTEM_EMAIL_TEMPLATE_VALID_CODE_LOGIN_FOR_B_KEY =
            "SYSTEM_EMAIL_TEMPLATE_VALID_CODE_LOGIN_FOR_B";

    /**
     * C端登录验证码邮件消息模板内容
     */
    private static final String SYSTEM_EMAIL_TEMPLATE_VALID_CODE_LOGIN_FOR_C_KEY =
            "SYSTEM_EMAIL_TEMPLATE_VALID_CODE_LOGIN_FOR_C";

    /**
     * B端连续登录失败持续时间（即N分钟内连续登录失败，单位：分钟）
     */
    private static final String SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_DURATION_FOR_B_KEY =
            "SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_DURATION_FOR_B";

    /**
     * C端连续登录失败持续时间（即N分钟内连续登录失败，单位：分钟）
     */
    private static final String SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_DURATION_FOR_C_KEY =
            "SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_DURATION_FOR_C";

    /**
     * B端连续登录失败次数（即指定分钟内连续登录失败N次）
     */
    private static final String SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_TIMES_FOR_B_KEY =
            "SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_TIMES_FOR_B";

    /**
     * C端连续登录失败次数（即指定分钟内连续登录失败N次）
     */
    private static final String SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_TIMES_FOR_C_KEY =
            "SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_TIMES_FOR_C";

    /**
     * B端连续登录失败锁定时间（即指定分钟内连续登录失败指定次数，锁定N分钟，单位：分钟）
     */
    private static final String SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_LOCK_DURATION_FOR_B_KEY =
            "SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_LOCK_DURATION_FOR_B";

    /**
     * C端连续登录失败锁定时间（即指定分钟内连续登录失败指定次数，锁定N分钟，单位：分钟）
     */
    private static final String SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_LOCK_DURATION_FOR_C_KEY =
            "SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_LOCK_DURATION_FOR_C";

    /**
     * B端手机号登录是否开启
     */
    private static final String SYSTEM_SYS_DEFAULT_ALLOW_PHONE_LOGIN_FLAG_FOR_B_KEY =
            "SYSTEM_SYS_DEFAULT_ALLOW_PHONE_LOGIN_FLAG_FOR_B";

    /**
     * C端手机号登录是否开启
     */
    private static final String SYSTEM_SYS_DEFAULT_ALLOW_PHONE_LOGIN_FLAG_FOR_C_KEY =
            "SYSTEM_SYS_DEFAULT_ALLOW_PHONE_LOGIN_FLAG_FOR_C";

    /**
     * B端邮箱登录是否开启
     */
    private static final String SYSTEM_SYS_DEFAULT_ALLOW_EMAIL_LOGIN_FLAG_FOR_B_KEY =
            "SYSTEM_SYS_DEFAULT_ALLOW_EMAIL_LOGIN_FLAG_FOR_B";

    /**
     * C端邮箱登录是否开启
     */
    private static final String SYSTEM_SYS_DEFAULT_ALLOW_EMAIL_LOGIN_FLAG_FOR_C_KEY =
            "SYSTEM_SYS_DEFAULT_ALLOW_EMAIL_LOGIN_FLAG_FOR_C";

    /**
     * B端手机号无对应用户时策略
     */
    private static final String SYSTEM_SYS_DEFAULT_STRATEGY_WHEN_NO_USER_WITH_PHONE_FOR_B_KEY =
            "SYSTEM_SYS_DEFAULT_STRATEGY_WHEN_NO_USER_WITH_PHONE_FOR_B";

    /**
     * C端手机号无对应用户时策略
     */
    private static final String SYSTEM_SYS_DEFAULT_STRATEGY_WHEN_NO_USER_WITH_PHONE_FOR_C_KEY =
            "SYSTEM_SYS_DEFAULT_STRATEGY_WHEN_NO_USER_WITH_PHONE_FOR_C";

    /**
     * B端邮箱无对应用户时策略
     */
    private static final String SYSTEM_SYS_DEFAULT_STRATEGY_WHEN_NO_USER_WITH_EMAIL_FOR_B_KEY =
            "SYSTEM_SYS_DEFAULT_STRATEGY_WHEN_NO_USER_WITH_EMAIL_FOR_B";

    /**
     * C端邮箱无对应用户时策略
     */
    private static final String SYSTEM_SYS_DEFAULT_STRATEGY_WHEN_NO_USER_WITH_EMAIL_FOR_C_KEY =
            "SYSTEM_SYS_DEFAULT_STRATEGY_WHEN_NO_USER_WITH_EMAIL_FOR_C";

    /**
     * B端注册是否开启
     */
    private static final String SYSTEM_SYS_DEFAULT_ALLOW_REGISTER_FLAG_FOR_B_KEY =
            "SYSTEM_SYS_DEFAULT_ALLOW_REGISTER_FLAG_FOR_B";

    /**
     * C端注册是否开启
     */
    private static final String SYSTEM_SYS_DEFAULT_ALLOW_REGISTER_FLAG_FOR_C_KEY =
            "SYSTEM_SYS_DEFAULT_ALLOW_REGISTER_FLAG_FOR_C";
    ...
    public String getPhoneValidCode(AuthGetPhoneValidCodeParam authGetPhoneValidCodeParam, String type) {
        ...
        if (SaClientTypeEnum.B.getValue().equals(type)) {
            smsTemplateCode = devConfigApi.getValueByKey(SYSTEM_SMS_TEMPLATE_VALID_CODE_LOGIN_FOR_B_KEY);
        } else {
            smsTemplateCode = devConfigApi.getValueByKey(SYSTEM_SMS_TEMPLATE_VALID_CODE_LOGIN_FOR_C_KEY);
        }
        ...
        // 将请求号作为key，验证码的值作为value放到redis，用于校验
        commonCacheOperator.put(AUTH_VALID_CODE_CACHE_KEY + phone + StrUtil.UNDERLINE
                + phoneValidCodeReqNo, phoneValidCode, validCodeExpiredDuration);
        // 返回请求号
    ...
    private void checkAllowPhoneLoginFlag(String type) {
        ...
        if (SaClientTypeEnum.B.getValue().equals(type)) {
            allowPhoneLoginFlag = devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_ALLOW_PHONE_LOGIN_FLAG_FOR_B_KEY);
        } else {
            allowPhoneLoginFlag = devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_ALLOW_PHONE_LOGIN_FLAG_FOR_C_KEY);
        }
    ...
    public String getEmailValidCode(AuthGetEmailValidCodeParam authGetEmailValidCodeParam, String type) {
        ...
        if (SaClientTypeEnum.B.getValue().equals(type)) {
            emailTemplateContent = devConfigApi.getValueByKey(SYSTEM_EMAIL_TEMPLATE_VALID_CODE_LOGIN_FOR_B_KEY);
        } else {
            emailTemplateContent = devConfigApi.getValueByKey(SYSTEM_EMAIL_TEMPLATE_VALID_CODE_LOGIN_FOR_C_KEY);
        }
        ...
        // 将请求号作为key，验证码的值作为value放到redis，用于校验
        commonCacheOperator.put(AUTH_VALID_CODE_CACHE_KEY + email + StrUtil.UNDERLINE
                + emailValidCodeReqNo, emailValidCode, validCodeExpiredDuration);
        // 返回请求号
    ...
    private void checkAllowEmailLoginFlag(String type) {
        ...
        if (SaClientTypeEnum.B.getValue().equals(type)) {
            allowEmailLoginFlag = devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_ALLOW_EMAIL_LOGIN_FLAG_FOR_B_KEY);
        } else {
            allowEmailLoginFlag = devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_ALLOW_EMAIL_LOGIN_FLAG_FOR_C_KEY);
        }
    ...
    private void validValidCode(String phoneOrEmail, String validCode, String validCodeReqNo) {
        ...
        if (ObjectUtil.isEmpty(phoneOrEmail)) {
            ...
            // 手机或者邮箱验证码
            existValidCode = commonCacheOperator.get(AUTH_VALID_CODE_CACHE_KEY + phoneOrEmail
                    + StrUtil.UNDERLINE + validCodeReqNo);
        }
        // 缓存中不存在验证码则返回失效错误
        ...
        if (ObjectUtil.isEmpty(phoneOrEmail)) {
            ...
            // 手机或者邮箱验证码
            commonCacheOperator.remove(AUTH_VALID_CODE_CACHE_KEY + phoneOrEmail
                    + StrUtil.UNDERLINE + validCodeReqNo);
        }
    }
        ...
        if (SaClientTypeEnum.B.getValue().equals(type)) {
            if (phoneOrEmailType.equals(AuthPhoneOrEmailTypeEnum.PHONE.getValue())) {
                ...
                if (ObjectUtil.isEmpty(saBaseLoginUser)) {
                    // B端手机号无对应用户时策略
                    return devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_STRATEGY_WHEN_NO_USER_WITH_PHONE_FOR_B_KEY);
                } else {
                    // 存在则允许登录
                ...
                if (ObjectUtil.isEmpty(saBaseLoginUser)) {
                    // B端邮箱无对应用户时策略
                    return devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_STRATEGY_WHEN_NO_USER_WITH_EMAIL_FOR_B_KEY);
                } else {
                    // 存在则允许登录
                    return AuthStrategyWhenNoUserWithPhoneOrEmailEnum.ALLOW_LOGIN.getValue();
                }
            ...
            if (phoneOrEmailType.equals(AuthPhoneOrEmailTypeEnum.PHONE.getValue())) {
                ...
                if (ObjectUtil.isEmpty(saBaseClientLoginUser)) {
                    // C端手机号无对应用户时策略
                    return devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_STRATEGY_WHEN_NO_USER_WITH_PHONE_FOR_C_KEY);
                } else {
                    // 存在则允许登录
                    return AuthStrategyWhenNoUserWithPhoneOrEmailEnum.ALLOW_LOGIN.getValue();
                }
                ...
                if (ObjectUtil.isEmpty(saBaseClientLoginUser)) {
                    // C端邮箱无对应用户时策略
                    return devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_STRATEGY_WHEN_NO_USER_WITH_EMAIL_FOR_C_KEY);
                } else {
                    // 存在则允许登录
                    return AuthStrategyWhenNoUserWithPhoneOrEmailEnum.ALLOW_LOGIN.getValue();
                }
    ...
    public String doLogin(AuthAccountPasswordLoginParam authAccountPasswordLoginParam, String type) {
        ...
        if (SaClientTypeEnum.B.getValue().equals(type)) {
            defaultCaptchaOpen = devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_CAPTCHA_OPEN_FLAG_FOR_B_KEY);
        } else {
            defaultCaptchaOpen = devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_CAPTCHA_OPEN_FLAG_FOR_C_KEY);
        }
    ...
    public String doLoginByPhone(AuthPhoneValidCodeLoginParam authPhoneValidCodeLoginParam, String type) {
        ...
        if (SaClientTypeEnum.B.getValue().equals(type)) {
            ...
            if (ObjectUtil.isEmpty(strategyWhenNoUserWithPhoneOrEmail)) {
                ...
                // 如果不允许登录，则抛出异常
                if (AuthStrategyWhenNoUserWithPhoneOrEmailEnum.NOT_ALLOW_LOGIN.getValue()
                        .equals(strategyWhenNoUserWithPhoneOrEmail)) {
                    throw new CommonException("手机号码：{}不存在对应用户", phone);
                } else {
                    // 定义B端用户
                    SaBaseLoginUser saBaseLoginUser;
                    if (AuthStrategyWhenNoUserWithPhoneOrEmailEnum.ALLOW_LOGIN.getValue()
                            .equals(strategyWhenNoUserWithPhoneOrEmail)) {
                        // 允许登录，即用户存在
                        saBaseLoginUser = loginUserApi.getUserByPhone(phone);
                    } else if (AuthStrategyWhenNoUserWithPhoneOrEmailEnum.AUTO_CREATE_USER.getValue()
                            .equals(strategyWhenNoUserWithPhoneOrEmail)) {
                        // 根据手机号自动创建B端用户
                        saBaseLoginUser = loginUserApi.createUserWithPhone(phone);
                    } else {
                        throw new CommonException("不支持的手机号或邮箱无对应用户时策略类型：{}",
                                strategyWhenNoUserWithPhoneOrEmail);
                    }
                    // 执行B端登录
                    return execLoginB(saBaseLoginUser, device);
                }
    ...
    private int saveLoginTimes(String userAccount, String type) {
        ...
        if (SaClientTypeEnum.B.getValue().equals(type)) {
            configContinuousLoginFailDuration =
                    devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_DURATION_FOR_B_KEY);
            configContinuousLoginFailTimes =
                    devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_TIMES_FOR_B_KEY);
            configContinuousLoginFailLockDuration =
                    devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_LOCK_DURATION_FOR_B_KEY);
        } else {
            configContinuousLoginFailDuration =
                    devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_DURATION_FOR_C_KEY);
            configContinuousLoginFailTimes =
                    devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_TIMES_FOR_C_KEY);
            configContinuousLoginFailLockDuration =
                    devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_CONTINUOUS_LOGIN_FAIL_LOCK_DURATION_FOR_C_KEY);
        }
        // 连续登录失败持续时间默认5分钟
    ...
    private void fillSaBaseLoginUserAndUpdateCache(SaBaseLoginUser saBaseLoginUser) {
        ...
        // 权限码列表存入缓存
        commonCacheOperator.put(CacheConstant.AUTH_B_PERMISSION_LIST_CACHE_KEY
                + saBaseLoginUser.getId(), permissionCodeList);
        // 获取角色码
    ...
    private String execLoginC(SaBaseClientLoginUser saBaseClientLoginUser, String device) {
        ...
        StpClientUtil.login(saBaseClientLoginUser.getId(), new SaLoginModel().setDevice(device)
                .setExtra("name", saBaseClientLoginUser.getName()));
        // 填充C端用户信息并更新缓存
    ...
    private void fillSaBaseClientLoginUserAndUpdateCache(SaBaseClientLoginUser saBaseClientLoginUser) {
        ...
        // 角色id和用户id集合
        List<String> userAndRoleIdList = CollectionUtil.unionAll(roleIdList,
                CollectionUtil.newArrayList(saBaseClientLoginUser.getId()));
        // 获取按钮码
        saBaseClientLoginUser.setButtonCodeList(
                clientLoginUserApi.getButtonCodeListListByUserAndRoleIdList(userAndRoleIdList));
        // 获取移动端按钮码
        saBaseClientLoginUser.setMobileButtonCodeList(
        ...
        // 权限码列表存入缓存
        commonCacheOperator.put(CacheConstant.AUTH_C_PERMISSION_LIST_CACHE_KEY + saBaseClientLoginUser.getId(),
                permissionCodeList);
        // 获取角色码
    ...
    private void checkAllowRegisterFlag(String type) {
        ...
        if (SaClientTypeEnum.B.getValue().equals(type)) {
            allowRegisterFlag = devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_ALLOW_REGISTER_FLAG_FOR_B_KEY);
        } else {
            allowRegisterFlag = devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_ALLOW_REGISTER_FLAG_FOR_C_KEY);
        }
    ...
    private long getValidCodeExpiredDuration(String type) {
        ...
        if (SaClientTypeEnum.B.getValue().equals(type)) {
            configCaptchaExpiredDuration =
                    devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_CAPTCHA_EXPIRED_DURATION_FOR_B_KEY);
        } else {
            configCaptchaExpiredDuration =
                    devConfigApi.getValueByKey(SYSTEM_SYS_DEFAULT_CAPTCHA_EXPIRED_DURATION_FOR_C_KEY);
        }
        // 判断是否为空

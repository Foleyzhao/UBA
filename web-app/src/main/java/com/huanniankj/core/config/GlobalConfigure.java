package com.huanniankj.core.config;
...
import com.huanniankj.common.annotation.CommonNoRepeat;
import com.huanniankj.common.annotation.CommonWrapper;
import com.huanniankj.common.cache.CommonCacheOperator;
import com.huanniankj.common.enums.CommonDeleteFlagEnum;
import com.huanniankj.common.exception.CommonException;
import com.huanniankj.common.interceptor.CommonTraceInterceptor;
...
import com.huanniankj.core.handler.GlobalExceptionUtil;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.huanniankj.**.mapper"})
public class GlobalConfigure implements WebMvcConfigurer {
    ...
    public static final String[] NO_LOGIN_PATH_ARR = {
            ...
            "/auth/c/register", "/auth/c/getEmailValidCode", "/auth/c/doLoginByEmail",

            "/auth/b/getPicCaptcha", "/auth/b/getPhoneValidCode", "/auth/b/doLogin", "/auth/b/doLoginByPhone",
            "/auth/b/register", "/auth/b/getEmailValidCode", "/auth/b/doLoginByEmail",
            ...
            /* 用户个人中心相关 */
            "/sys/userCenter/getPicCaptcha", "/sys/userCenter/findPasswordGetPhoneValidCode",
            "/sys/userCenter/findPasswordGetEmailValidCode", "/sys/userCenter/findPasswordByPhone",
     ...
     * 仅超管使用的接口地址集合
     */
    private static final String[] SUPER_PERMISSION_PATH_ARR = {"/auth/session/**", "/auth/third/page",
            "/client/user/**", "/sys/org/**", "/sys/group/**", "/sys/position/**", "/sys/button/**",
            "/sys/menu/**", "/sys/module/**", "/sys/role/**", "/sys/user/**", "/sys/index/bizDataCount",
            "/sys/index/opDataCount", "/sys/index/toolDataCount", "/dev/config/**", "/dev/dict/**", "/dev/email/page",
            "/dev/email/delete", "/dev/email/detail", "/dev/file/page", "/dev/file/list", "/dev/file/delete",
            "/dev/file/detail", "/dev/job/**", "/dev/log/**", "/dev/message/page", "/dev/message/delete",
            "/dev/message/detail", "/dev/monitor/**", "/dev/sms/page", "/dev/sms/delete", "/dev/sms/detail",
            "/dev/slideshow/**", "/gen/basic/**", "/gen/config/**", "/mobile/menu/**", "/mobile/module/**",};
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("doc.html").addResourceLocations(ResourceUtils.CLASSPATH_URL_PREFIX
                + "/META-INF/resources/");
        registry.addResourceHandler("/webjars/**").addResourceLocations(ResourceUtils.CLASSPATH_URL_PREFIX
    ...
    public static class CommonNoRepeatAop {
         ...
         * 切入点
         */
        @Pointcut("@annotation(com.huanniankj.common.annotation.CommonNoRepeat)")
                ...
                if (cacheJsonObject.containsKey(url)) {
                    ...
                    if (jsonObject.getStr("repeatParam").equals(existRepeatJsonObject.getStr("repeatParam"))) {
                        ...
                        if (interval < commonNoRepeat.interval()) {
                            ...
                            if (secondsParam > 0) {
                                throw new CommonException("请求过于频繁，请"
                                        + CommonTimeFormatUtil.formatSeconds(secondsParam) + "后再试");
                            }
                        }
                    }
                }
    ...
    public static class CommonWrapperAop {
         ...
         * 切入点
         */
        @Pointcut("@annotation(com.huanniankj.common.annotation.CommonWrapper)")
         ...
         */
        @SuppressWarnings("ALL")
        private JSONObject wrapPureObject(
                Object originModel, Class<? extends CommonWrapperInterface<?>>[] baseWrapperClasses) {
